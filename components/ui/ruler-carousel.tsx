...
export const DEFAULT_RULER_ITEMS: CarouselItem[] = [
  { id: 1, title: "WEBSITES" },
  { id: 2, title: "WEB APPS" },
...
export function RulerCarousel({
  originalItems = DEFAULT_RULER_ITEMS,
  className,
}: RulerCarouselProps) {
  ...
  const initialIndex = Math.min(itemsPerSet + 4, infiniteItems.length - 1);
  ...
  return (
    <div
      className={cn(
        "w-full py-16 md:py-24 flex flex-col items-center justify-center bg-background dark:bg-black overflow-hidden select-none",
        className
      )}
    >
      ...
      <div className="flex items-center justify-center gap-4 mt-10">
        <button
          ...
          className="flex items-center justify-center cursor-pointer p-1 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
