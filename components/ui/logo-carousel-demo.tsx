...
export function PierreIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 74 20"
      width={74}
...
export const ClaudeAIIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <rect fill="#D97706" width={512} height={512} rx={104.187} ry={105.042} />
    <path
      fill="#1F1F1E"
      fillRule="nonzero"
...
export function ViteIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M30.6 4.9L16.8 29.5a1.2 1.2 0 01-2.1 0L1.4 4.9A1.2 1.2 0 012.4 3.2h27.2a1.2 1.2 0 011 1.7z"
        fill="#BD34FE"
      />
      <path
        d="M21.5 3.2L16 13.5l-3.3-6.2H2.4l13.3 23.9 4-7.2L29.6 3.2h-8.1z"
        fill="#FFD62E"
      />
    </svg>
  );
