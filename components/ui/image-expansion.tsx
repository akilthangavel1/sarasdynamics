...
export function ImageExpansionSlider() {
  ...
  return (
    <div
      className={`w-full p-6 md:p-10 rounded-2xl border shadow-2xl overflow-hidden font-sans select-none transition-all duration-300 ${
        isDarkMode
          ...
          >
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-sm text-zinc-400">
                {selectedImageIndex + 1} of {totalDots}
              </p>
            </div>
          </div>
