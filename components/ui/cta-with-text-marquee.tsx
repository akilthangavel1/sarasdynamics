...
export function CTAWithVerticalMarquee({
  ...
  description = "Pick one workflow. Dali Agents builds a fixed-scope agent against an acceptance test agreed upfront. It works - or you don't pay.",
  primaryCtaText = "START WITH ONE AGENT",
  secondaryCtaText = "GET A FIXED QUOTE",
  onPrimaryCtaClick,
  onSecondaryCtaClick,
  className,
          ...
          <div className="space-y-8 max-w-xl">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in-up [animation-delay:600ms]">
              <button
                ...
                className="group relative px-6 py-3 bg-foreground text-background rounded-md font-medium overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer"
              >
              ...
              <button
                ...
                className="group relative px-6 py-3 bg-secondary text-secondary-foreground rounded-md font-medium overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg border border-border cursor-pointer"
              >
